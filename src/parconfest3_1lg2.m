function [lb,ub,hs,net_nopt,xch_nopt,nscore,nflag,I,lub_lg,lub_lg_s,lb_opt_nx,ub_opt_nx] = parconfest3_1lg2(simulate,model,net,xch,ineq,input,mea,fmea,var,lb_in,ub_in,I_in,cache_in)
...
% 	lb_opt_lg=[lb_opt_ratio(12)*lb_opt_ratio(13)*lb_opt_ratio(14)*lb_opt_ratio(15)*lb_opt_ratio(16)*lb_opt_ratio(17)*lb_opt_ratio(18); lb_opt_ratio(12)*lb_opt_ratio(13); lb_opt_ratio(14)*lb_opt_ratio(15)*lb_opt_ratio(16)*lb_opt_ratio(17)*lb_opt_ratio(18); lb_opt_ratio(14)*lb_opt_ratio(15)*lb_opt_ratio(16); lb_opt_ratio(14)*lb_opt_ratio(15); lb_opt_ratio(15)*lb_opt_ratio(16);  lb_opt_ratio(16)*lb_opt_ratio(17)*lb_opt_ratio(18); lb_opt_ratio(16)*lb_opt_ratio(17); lb_opt_ratio(17)*lb_opt_ratio(18)];
    % Below is for ecoli
    lb_opt_lg=[lb_opt_ratio(12)*lb_opt_ratio(13)*lb_opt_ratio(14)*lb_opt_ratio(15)*lb_opt_ratio(16)*lb_opt_ratio(17)*lb_opt_ratio(18); lb_opt_ratio(12)*lb_opt_ratio(13); lb_opt_ratio(14)*lb_opt_ratio(15)*lb_opt_ratio(16)*lb_opt_ratio(17)*lb_opt_ratio(18); lb_opt_ratio(14)*lb_opt_ratio(15)*lb_opt_ratio(16); lb_opt_ratio(14)*lb_opt_ratio(15); lb_opt_ratio(15)*lb_opt_ratio(16);  lb_opt_ratio(16)*lb_opt_ratio(17)*lb_opt_ratio(18); lb_opt_ratio(16)*lb_opt_ratio(17); lb_opt_ratio(17)*lb_opt_ratio(18);lb_opt_ratio(10)*lb_opt_ratio(11);lb_opt_ratio(10)*lb_opt_ratio(11)*lb_opt_ratio(12)*lb_opt_ratio(13)*lb_opt_ratio(14)*lb_opt_ratio(15)*lb_opt_ratio(16)*lb_opt_ratio(17)*lb_opt_ratio(18)];
%     ub_opt_lg=lb_opt_lg;
%     lub_lg_s={'FBA<->ENO';'FBA<->TPI';'GAPDH<->ENO';'GAPDH<->PGM1';'GAPDH<->PGK';'PGK<->PGM1';'PGM12<->ENO';'PGM12';'PGM2<->ENO'};
...
%         ratio_ss=[ratio_s(12)*ratio_s(13)*ratio_s(14)*ratio_s(15)*ratio_s(16)*ratio_s(17)*ratio_s(18); ratio_s(12)*ratio_s(13); ratio_s(14)*ratio_s(15)*ratio_s(16)*ratio_s(17)*ratio_s(18); ratio_s(14)*ratio_s(15)*ratio_s(16); ratio_s(14)*ratio_s(15); ratio_s(15)*ratio_s(16);  ratio_s(16)*ratio_s(17)*ratio_s(18); ratio_s(16)*ratio_s(17); ratio_s(17)*ratio_s(18)];
        % Below is for ecoli
        ratio_ss=[ratio_s(12)*ratio_s(13)*ratio_s(14)*ratio_s(15)*ratio_s(16)*ratio_s(17)*ratio_s(18); ratio_s(12)*ratio_s(13); ratio_s(14)*ratio_s(15)*ratio_s(16)*ratio_s(17)*ratio_s(18); ratio_s(14)*ratio_s(15)*ratio_s(16); ratio_s(14)*ratio_s(15); ratio_s(15)*ratio_s(16);  ratio_s(16)*ratio_s(17)*ratio_s(18); ratio_s(16)*ratio_s(17); ratio_s(17)*ratio_s(18);ratio_s(10)*ratio_s(11);ratio_s(10)*ratio_s(11)*ratio_s(12)*ratio_s(13)*ratio_s(14)*ratio_s(15)*ratio_s(16)*ratio_s(17)*ratio_s(18)];
