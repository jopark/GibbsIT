function [lb,ub,hs,net_nopt,xch_nopt,nscore,nflag,I,lub_lg,lub_lg_s,lb_opt_nx,ub_opt_nx] = parconfest3_1lg2_ccell(simulate,model,net,xch,ineq,input,mea,fmea,var,lb_in,ub_in,I_in,cache_in)
...
thr=3.84; % 95%:3.84, 90%:2.71, 68%:0.989, dof=1; threshold value for confidence intervals
...
elseif nargin==13 && isempty(lb_in) && isempty(ub_in) && isempty(I_in) && ~isempty(cache_in)
    ...
    lb_opt_ratio=lb_opt_fr(:,1)./lb_opt_fr(:,2);
    ub_opt_ratio=ub_opt_fr(:,1)./ub_opt_fr(:,2);
% 	lb_opt_lg=[lb_opt_ratio(11)*lb_opt_ratio(12)*lb_opt_ratio(13)*lb_opt_ratio(14)*lb_opt_ratio(15)*lb_opt_ratio(16)*lb_opt_ratio(17); lb_opt_ratio(11)*lb_opt_ratio(12); lb_opt_ratio(13)*lb_opt_ratio(14)*lb_opt_ratio(15)*lb_opt_ratio(16)*lb_opt_ratio(17); lb_opt_ratio(13)*lb_opt_ratio(14); lb_opt_ratio(14)*lb_opt_ratio(15);  lb_opt_ratio(15)*lb_opt_ratio(16)*lb_opt_ratio(17); lb_opt_ratio(15)*lb_opt_ratio(16); lb_opt_ratio(16)*lb_opt_ratio(17)];
% 	lb_opt_lg=[lb_opt_ratio(12)*lb_opt_ratio(13)*lb_opt_ratio(14)*lb_opt_ratio(15)*lb_opt_ratio(16)*lb_opt_ratio(17)*lb_opt_ratio(18); lb_opt_ratio(12)*lb_opt_ratio(13); lb_opt_ratio(14)*lb_opt_ratio(15)*lb_opt_ratio(16)*lb_opt_ratio(17)*lb_opt_ratio(18); lb_opt_ratio(14)*lb_opt_ratio(15)*lb_opt_ratio(16); lb_opt_ratio(14)*lb_opt_ratio(15); lb_opt_ratio(15)*lb_opt_ratio(16);  lb_opt_ratio(16)*lb_opt_ratio(17)*lb_opt_ratio(18); lb_opt_ratio(16)*lb_opt_ratio(17); lb_opt_ratio(17)*lb_opt_ratio(18)];
    % Below is for cther_tsac_ccell
    lb_opt_lg=[lb_opt_ratio(9)*lb_opt_ratio(10)*lb_opt_ratio(11)*lb_opt_ratio(12)*lb_opt_ratio(13)*lb_opt_ratio(14)*lb_opt_ratio(15); lb_opt_ratio(9)*lb_opt_ratio(10); lb_opt_ratio(11)*lb_opt_ratio(12)*lb_opt_ratio(13)*lb_opt_ratio(14)*lb_opt_ratio(15); lb_opt_ratio(11)*lb_opt_ratio(12)*lb_opt_ratio(13); lb_opt_ratio(11)*lb_opt_ratio(12); lb_opt_ratio(12)*lb_opt_ratio(13);  lb_opt_ratio(13)*lb_opt_ratio(14)*lb_opt_ratio(15); lb_opt_ratio(13)*lb_opt_ratio(14); lb_opt_ratio(14)*lb_opt_ratio(15);lb_opt_ratio(7)*lb_opt_ratio(8);lb_opt_ratio(7)*lb_opt_ratio(8)*lb_opt_ratio(9)*lb_opt_ratio(10)*lb_opt_ratio(11)*lb_opt_ratio(12)*lb_opt_ratio(13)*lb_opt_ratio(14)*lb_opt_ratio(15)];
%     ub_opt_lg=lb_opt_lg;
    lub_lg_s={'FBA<->ENO';'FBA<->TPI';'GAPDH<->ENO';'GAPDH<->PGM1';'GAPDH<->PGK';'PGK<->PGM1';'PGM12<->ENO';'PGM12';'PGM2<->ENO';'PGI<->PFK';'PGI<->ENO'};
...
hs_ub=-hs_lb;
lb_lg=inf(length(lb_opt_lg),length(I));
ub_lg=-lb_lg;
...
if ~isempty(cstatus)
    for ii=1:l_I
        if cstatus(ii)==1
			...
			eval(['lb_lg(:,ii) = cin.lblg_' num2str(I(ii)) ';']);
            eval(['ub_lg(:,ii) = cin.ublg_' num2str(I(ii)) ';']);
        elseif cstatus(ii)==2
            eval(['lb_s(ii) = cin.lbs_' num2str(I(ii)) ';']);
...
% save current results to cache
    ...
    var_lb_lg=['lblg_' num2str(I(ii))];
    var_ub_lg=['ublg_' num2str(I(ii))];
...
% LOWERBOUND
    ...
    while info.fval-nscore(ii)<=thr && ~max(d(n_l_1:end)<0) && it<i_tol && min(ineq.A*d<=ineq.b)
		...
		% Calculate product of for/rev ratios
%         ratio_ss=[ratio_s(11)*ratio_s(12)*ratio_s(13)*ratio_s(14)*ratio_s(15)*ratio_s(16)*ratio_s(17); ratio_s(11)*ratio_s(12); ratio_s(13)*ratio_s(14)*ratio_s(15)*ratio_s(16)*ratio_s(17); ratio_s(13)*ratio_s(14); ratio_s(14)*ratio_s(15); ratio_s(15)*ratio_s(16)*ratio_s(17); ratio_s(15)*ratio_s(16); ratio_s(16)*ratio_s(17)];
%         ratio_ss=[ratio_s(12)*ratio_s(13)*ratio_s(14)*ratio_s(15)*ratio_s(16)*ratio_s(17)*ratio_s(18); ratio_s(12)*ratio_s(13); ratio_s(14)*ratio_s(15)*ratio_s(16)*ratio_s(17)*ratio_s(18); ratio_s(14)*ratio_s(15)*ratio_s(16); ratio_s(14)*ratio_s(15); ratio_s(15)*ratio_s(16);  ratio_s(16)*ratio_s(17)*ratio_s(18); ratio_s(16)*ratio_s(17); ratio_s(17)*ratio_s(18)];
        % Below is for cther_tsac_ccell
		ratio_ss=[ratio_s(9)*ratio_s(10)*ratio_s(11)*ratio_s(12)*ratio_s(13)*ratio_s(14)*ratio_s(15); ratio_s(9)*ratio_s(10); ratio_s(11)*ratio_s(12)*ratio_s(13)*ratio_s(14)*ratio_s(15); ratio_s(11)*ratio_s(12)*ratio_s(13); ratio_s(11)*ratio_s(12); ratio_s(12)*ratio_s(13);  ratio_s(13)*ratio_s(14)*ratio_s(15); ratio_s(13)*ratio_s(14); ratio_s(14)*ratio_s(15);ratio_s(7)*ratio_s(8);ratio_s(7)*ratio_s(8)*ratio_s(9)*ratio_s(10)*ratio_s(11)*ratio_s(12)*ratio_s(13)*ratio_s(14)*ratio_s(15)];
        
        % Update if ratio product is smaller or greater than current ratio product
        tmp=lb_lg(:,ii);
        I_s=ratio_ss<tmp;
        tmp(I_s)=ratio_ss(I_s);
        lb_lg(:,ii)=tmp;
...
%         disp([num2str(I(ii)) ': ineq = ', num2str(min(ineq.A*d<=ineq.b)), '; eq = ', num2str(min(eq.A*d==eq.b))])
    ...
    status=status+1;
	try
		saveappend(cacheFile,var_lb_s,var_lb_nx,var_ub_nx,var_lb_fr,var_ub_fr,var_lb_ratio,var_ub_ratio,var_lb_lg,var_ub_lg,lb_s(ii),lb_nx(:,:,ii),ub_nx(:,:,ii),lb_fr(:,:,ii),ub_fr(:,:,ii),lb_ratio(:,ii),ub_ratio(:,ii),lb_lg(:,ii),ub_lg(:,ii));
...
%                     d=d-hcoef*dd;
    ...
    status=status+1;
	try
		saveappend(cacheFile,var_ub_s,var_lb_nx,var_ub_nx,var_lb_fr,var_ub_fr,var_lb_ratio,var_ub_ratio,var_lb_lg,var_ub_lg,ub_s(ii),lb_nx(:,:,ii),ub_nx(:,:,ii),lb_fr(:,:,ii),ub_fr(:,:,ii),lb_ratio(:,ii),ub_ratio(:,ii),lb_lg(:,ii),ub_lg(:,ii));
		saveappend1(cacheFile,var_status,status);
	catch
% 		saveappend(cacheFile,var_ub_s,var_lb_nx,var_ub_nx,var_lb_fr,var_ub_fr,var_lb_ratio,var_ub_ratio,var_lb_lg,var_ub_lg,ub_s(ii),lb_nx(:,:,ii),ub_nx(:,:,ii),lb_fr(:,:,ii),ub_fr(:,:,ii),lb_ratio(:,ii),ub_ratio(:,ii),lb_lg(:,ii),ub_lg(:,ii));
% 		saveappend1(cacheFile,var_status,status);
...
function saveappend(fname,var_lub_s,var_lb_nx,var_ub_nx,var_lb_fr,var_ub_fr,var_lb_ratio,var_ub_ratio,var_lb_lg,var_ub_lg,lub_s,lb_nx,ub_nx,lb_fr,ub_fr,lb_ratio,ub_ratio,lb_lg,ub_lg)
...
eval([var_lb_lg '=lb_lg;']);
eval([var_ub_lg '=ub_lg;']);
save(fname,var_lub_s,var_lb_nx,var_ub_nx,var_lb_fr,var_ub_fr,var_lb_ratio,var_ub_ratio,var_lb_lg,var_ub_lg,'-append')